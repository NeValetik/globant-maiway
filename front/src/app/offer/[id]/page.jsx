...
import UploadPhotoSVG from "src/assets/buttons/UploadPhotoSVG";
import Navbar from "src/components/Navbar";
import Footer from "src/components/Footer";
import Tags from 'src/components/Tags';
import themeChangerDescriptionString from 'src/components/utils/themeChangerDescriptionString';
import { useTheme } from "src/context/ThemeContext";
import loading_cat from 'src/assets/loading_cat.gif';
        ...
        {!isEditing ? (
            <div className="flex-col relative mt-5">
                ...
                {userId === offer.author.userId && (
                    <button
                        className="flex flex-col mx-auto px-4 py-2 text-white my-2 rounded-lg bg-mwlightgreen"
                        onClick={handleClick}
                    >
                        Edit
                    </button>
            ...
            <form onSubmit={handleEditSubmit} className="mx-auto mt-8 p-4">
                ...
                <div className="mb-4">
                    ...
                    >
                        ...
                        {regions.map((regionItem) => (
                            <option key={regionItem.code} value={regionItem.code}>
                                {regionItem.name}
                            </option>
                        ))}
                    </select>
                ...
                <button
                    type="submit"
                    className={themeChangerDescriptionString(theme, 'hover:bg-[#016960] bg-[#629a8d]', 'bg-[#016960] hover:bg-[#629a8d]', "w-full py-2 px-4 rounded text-white")}
                >
                    Save Changes
                </button>
            </form>
